                  ...
                  <div class="slider-inner h-100">
                     <div class="row align-items-center  h-100">
                        <div class="col-xl-6 col-lg-12 col-md-12">
                           ...
                           </a>  removed logo from banner--> 
                           <!-- <h1 class="slider-text big-title title text-uppercase" data-animation-in="fadeInLeft"
                              data-delay-in="0.6">bushland</h1> -->
                           <div class="d-flex align-items-center" data-animation-in="fadeInUp" data-delay-in="1">
                              <span class="badge badge-danger p-2">18 </span>
                     ...
                     <div class="row align-items-center  h-100">
                        <div class="col-xl-6 col-lg-12 col-md-12">
                           ...
                           <div class="d-flex align-items-center" data-animation-in="fadeInUp" data-delay-in="0.5">
                              <span class="badge badge-danger p-2">16+</span>
                              <span class="ml-3"> </span> <!--2h 40m removed -->
                           </div>
                           <h3>Lorem Ipsum</h3>
                  ...
                  <div class="slider-inner h-100">
                     <div class="row align-items-center  h-100">
                        <div class="col-xl-6 col-lg-12 col-md-12">
                           ...
                           </a> logo slider3 remove-->                           
                           <div class="d-flex align-items-center" data-animation-in="fadeInUp" data-delay-in="0.5">
                              <span class="badge badge-danger p-2">20+</span>
                              <span class="ml-3"> </span> <!--3h removed-->
                           </div>
                           <h3>Lorem Ipsum</h3>
                           <p data-animation-in="fadeInUp" data-delay-in="0.7">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard
                              dummy text ever since the 1500s.
