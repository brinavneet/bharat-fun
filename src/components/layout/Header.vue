                     ...
                     <nav class="navbar navbar-expand-lg navbar-light p-0">
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                           <div class="menu-main-menu-container">
                              <ul id="top-menu" class="navbar-nav ml-auto">
                                 ...
                                 <li class="menu-item">
                                    <a href="show-category.html">About US</a>
                                 </li>
                                 <li class="menu-item">
                                    <a href="movie-category.html">Privacy</a>
                                 </li>
                                 <li class="menu-item">
                                    <a href="movie-category.html">Terms & Conditions</a>
                                 </li>
                                 <li class="menu-item">
                                    <a href="movie-category.html">Contact Us</a>
                                 </li>                                 
                              </ul>
                           </div>
                        </div>
                        <div class="mobile-more-menu">
                           <a href="javascript:void(0);" class="more-toggle" id="dropdownMenuButton"
                              data-toggle="more-toggle" aria-haspopup="true" aria-expanded="true">
                           ...
                           <div class="more-menu" aria-labelledby="dropdownMenuButton">
                              <div class="navbar-right position-relative">
                                 <ul class="d-flex align-items-center justify-content-end list-inline m-0">
                                    ...
                                    <li>
                                       <a href="#" class="iq-user-dropdown search-toggle d-flex align-items-center dropdown-toggle">
                                       ...
                                       <div class="iq-sub-dropdown iq-user-dropdown">
                                          <div class="iq-card shadow-none m-0">
                                             <div class="iq-card-body p-0 pl-3 pr-3">
                                                 <!----> 
                                                <img src="images/user/user.jpg" class="img-fluid avatar-40" alt="user"> User
                                                <!--//-->
                        ...
                        <div class="navbar-right menu-right">
                           <ul class="d-flex align-items-center list-inline m-0">
                              ...
                              <li class="nav-item nav-icon">
                                 <a href="#" class="iq-user-dropdown search-toggle p-0 d-flex align-items-center dropdown-toggle"
                                    ...
                                    <div class="iq-card shadow-none m-0">
                                       <div class="iq-card-body p-0 pl-3 pr-3">                                          
                                          <a href="manage-profile.html" class="iq-sub-card setting-dropdown">
                                             <div class="media align-items-center">
                                                <div class="right-icon"> 
                                                   <img src="images/user/user.jpg" class="img-fluid avatar-40" alt="user"/>
                                                </div>
                                                <div class="media-body ml-3">
